...
author: "Mathilde Halberg Nielsen"
...
Kongerækken <- read_csv2("data/spreadsheetkonge.csv")

```


```{r creating midyear column}
...
#Compare homicide and duration of reign 

We can see that the average of duration of reign for monarchs has increased through time, this could be due to better health, longer life expectancy, lesser wars or internal fights, democratization etc. 

The homicide charts have all started higher at different levels and have decreased for all countries represented, maybe also all because of a mix of different factors such as laws and punishment, better life expectancy, that people are generally richer etc. 
...
See the graph above for solution !
...
It can be a big and complex question to answer, because it opens the question of what civilized means and to conclude it from these visualizations is difficult. But looking at these visualizations I would say, that yes, there could be signs of more civilized nations today. The decreasing rates of homicide as well as the increasing average of duration of reign for monarchs could indicate that the civilization process has been underway for some centuries : democratization, laws and legal systems have been improved, the life expectancy has increased generally, people are richer etc. But that we cannot conclude this entirely from the visualizations because the data results here depends on a thousand others factors. 
